...
// applied/, not pending/: on this branch 192 has already been run against
// production (2026-09-09, 33 rows), so the artefact to keep honest is the
// archived copy, and a regeneration must not resurrect it as a pending one.
const SQL_OUT = join(ROOT, 'migrations/applied/192_seed_seo_redirects.sql')
