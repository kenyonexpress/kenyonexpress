...
console.log('product types:', tally(prods, 'type'))
console.log('statuses:', tally(prods, 'status'))
...
console.log(
  '\nproducts with EMPTY images:',
  noImages.length,
  noImages.map((p) => p.slug).slice(0, 40),
)
