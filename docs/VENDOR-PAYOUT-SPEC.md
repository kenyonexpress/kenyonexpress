...
### 5.2 שערים לפני Cardcom Financial (עתיד)

- [ ] מפתחות API נפרדים לקריאה מול פעולות יציאת כסף  
- [ ] Threat model כתוב + ביקורת  
- [ ] Sandbox מוכיח payout לספק בדיקה בלי כסף אמיתי  
- [ ] Rollback ל-CSV ידני נשאר זמין  
- [ ] LEGAL-TERMS מעודכן למועדי זיכוי אוטומטיים  
