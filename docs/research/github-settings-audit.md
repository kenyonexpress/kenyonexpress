...
אומת שוב בבדיקה חוזרת: אלה עדיין 5 הריצות האחרונות. ל-commit העדכני ביותר על main (3e4c16c, שדחף את שינוי ה-CI עצמו) עדיין לא רשומה ריצה, וגם דחיפות לענפי עבודה אחרים לא מפעילות את ה-workflow.
