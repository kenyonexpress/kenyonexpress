...
> ℹ️ **‏נכתב 19.08.2026. סומן 01.09.2026.**
>
> ‏עדיין שימושי כצ'קליסט תפעולי, אבל **אינו** רצף העלייה לאוויר. הרצף המדויק,
> ‏פקודה אחר פקודה עם rollback לכל שלב, הוא `docs/LAUNCH-RUNBOOK.md`, וכולל את
> ניתוח ה-DNS שאין כאן. שלבים ‏1 עד ‏6 שם כבר בוצעו.
