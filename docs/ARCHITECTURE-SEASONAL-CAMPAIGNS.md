...
|---|---|---|
| ראש השנה | אלול עד תשרי | מתנות, מסעדות, ספא |
...
| ל"ג בעומר / שבועות | אייר עד סיון | משפחות, אוכל |
| קיץ / בין הזמנים | יולי עד אוגוסט | אטרקציות, ילדים |
| בלאק פריידי / סייבר | נוב עד דצמ | הנחות רוחביות (זהירות LEGAL במחיר) |
| מבצע בזק ספונטני | שעות עד ימים | flash_price |
...
| 2026-08-07 | QA re-pass: en-dash בלוח חגים; קישור CONTRADICTIONS |
