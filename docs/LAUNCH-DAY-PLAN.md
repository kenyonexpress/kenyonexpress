...
>
> ‏‏T0 עדיין לא נקבע, ולכן לוח הזמנים כאן תקף. מה שהשתנה: **האתר כבר חי על
> ‏`kenyonexpress.vercel.app`**, כך ש-T0 הוא יום ה-DNS cutover בלבד ולא יום
> הפריסה. הרצף עצמו: `docs/LAUNCH-RUNBOOK.md` שלב 7.
