# החלטות זמניות שהתקבלו בלי אופיר

> <!-- v1-final-banner:2026-09-01 -->
> ‏**הקובץ הזה נקרא קודם `docs/DECISIONS.md` ושונה שמו ב-01.09.2026.**
> ‏`docs/DECISIONS.md` הוא עכשיו יומן ההחלטות הארכיטקטוניות המלא (ADR),
> והקובץ הזה נשאר כפי שהיה: ההכרעות הזמניות שנלקחו לבד בהיעדר תשובה,
> וכל אחת מהן עדיין ממתינה לאישור. שני הקבצים מקושרים זה לזה.
