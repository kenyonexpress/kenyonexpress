...
>
> שתי שורות כאן שגויות והשנייה מסוכנת:
>
> 1. ‏**‏Production Branch אינו `cursor/add-supabase-3c830`.** זה ענף נטוש,
>    וההצבעה אליו היא בדיוק הסיבה שאחד עשר דיפלוים נכשלו. הענף הוא
>    ‏`phase5/homepage`.
...
>    פעם, וזה הפיל כל בנייה ב-Vercel. הקובץ היום מעגן נתיבים בלוכסן מוביל,
>    וההסבר המלא כתוב בתוכו.
>
> ‏לרצף העלייה לאוויר: `docs/LAUNCH-RUNBOOK.md`.
