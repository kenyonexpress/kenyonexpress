...
> **הודעת איחוד (2026-07-17):** מקור האמת העדכני לדומיין הוא
> `docs/ARCHITECTURE-ANALYTICS-BI.md` (v2), שסוגר את השאלות הפתוחות כאן ומוסיף את
> שכבת 035 (דשבורד ספקים, take-rate, cohort retention, התחייבות פקיעה, ממשק סוכנים).
> מסמך זה נשאר כתיעוד התכנון של 033 בלבד.
