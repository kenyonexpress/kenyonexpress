...
ארכיטקטורת Progressive Web App: manifest, Service Worker, push.
...
Stack: Next.js App Router, **Serwist** (service worker), Web App Manifest, Hebrew RTL, brand yellow `#fed700`.
...
| 2026-08-03 | ke-arch docs-lifecycle: manifest, SW (Serwist), push |
