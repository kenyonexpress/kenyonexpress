...
Stack: Supabase Postgres (Pro + PITR), offsite `pg_dump`, Cloudflare R2, Vercel (code only), GitHub Actions לגיבויים מתוזמנים.
...
| 2026-08-03 | pack-20: imported to ke-arch docs-lifecycle |
