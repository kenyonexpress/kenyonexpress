...
Supersedes: כל טיוטה עם Escrow / held-until-redeem / תשלום קופון מהפלטפורמה לספק. גם דורס את קריאת C11(b) הישנה.
...
| Date | Change |
|---|---|
| 2026-08-03 | ke-arch docs-lifecycle: No Escrow binding (coupon prepaid stays on platform; till balance at merchant) |
