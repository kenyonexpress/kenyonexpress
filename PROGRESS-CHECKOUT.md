...
- עמלת פלטפורמה: 5% ברירת מחדל (ניתן לעקיפה פר מוצר ע"י אדמין), מחושבת על הסכום שעובר דרך הפלטפורמה (החיוב באתר).
- קופון: הלקוח משלם באתר אחוז מקדמה פר-מוצר (`upfront_percent`, אדמין). הסכום מוחזק ב-escrow. במימוש אצל הספק: escrow משוחרר לספק בניכוי העמלה. היתרה משולמת ישירות בעסק.
- פיזי: הלקוח משלם 100% באתר. פיצול מיידי (`split_executed`): ספק מקבל face פחות עמלה (5% ברירת מחדל או אחוז פר-מוצר).
