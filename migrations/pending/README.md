...
| `181_admin_rbac_hardening.sql` | `20260908203538` + `20260908203558` | `read_only_enum_181a` + `admin_rbac_hardening_181b` | verified 2026-09-09: `read_only` in `user_role`, `is_support()` body carries it, `enforce_profile_privilege_columns()` carries the admin-tier ladder, trigger attached, `profiles_super_admin_mfa` policy live |
