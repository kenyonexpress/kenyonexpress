    ...
    <header className="bg-white border-b border-gray-200">
      <div className="max-w-7xl mx-auto px-6 flex items-center gap-8" style={{ height: 80 }}>
        ...
        <Link href="/" className="flex items-center gap-3 shrink-0">
          ...
          >
            <svg xmlns="http://www.w3.org/2000/svg" className="w-7 h-7 text-gray-900" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="flex-1 flex justify-center">
          <button className="border border-gray-300 rounded-lg px-4 py-2.5 text-sm text-gray-600 flex items-center gap-2 hover:border-gray-400 transition-colors min-w-[200px]">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 text-gray-500 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 2C8.686 2 6 4.686 6 8c0 4.5 6 11 6 11s6-6.5 6-11c0-3.314-2.686-6-6-6zm0 8a2 2 0 110-4 2 2 0 010 4z" />
            </svg>
        ...
        <div className="flex items-center gap-1 shrink-0">
          ...
          <button className="relative p-2.5 hover:bg-gray-100 rounded-full transition-colors" title="עגלת קניות">
          ...
          <button className="p-2.5 hover:bg-gray-100 rounded-full transition-colors" title="רשימת משאלות">
            <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 text-gray-700" fill="none" viewBox="0 0 24 24" stroke="currentColor">
