...
export default function MainHeader({ user }: Props) {
  return (
    <header dir="rtl" lang="he" className="bg-white border-b border-gray-200">
      <div className="max-w-7xl mx-auto px-6 flex items-center gap-8" style={{ height: 80 }}>
        ...
        <Link href="/" className="flex items-center gap-3 shrink-0">
          ...
          <div className="leading-tight">
            <div className="font-black text-xl text-gray-900 tracking-tight">קניון EXPRESS</div>
            <div className="text-xs text-gray-500">מסדרים לך בילוי</div>
          </div>
        </Link>
        ...
        {/* Action icons — last in DOM = leftmost in RTL */}
        {/* DOM: [cart] [user] [heart]  →  RTL visual: [heart] [user] [cart] */}
