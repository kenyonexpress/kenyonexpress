  ...
  return (
    <footer dir="rtl" className="w-full">
      ...
      <div className="bg-brand-secondary">
        <div className="max-w-page mx-auto px-4 py-6 flex flex-col md:flex-row items-center justify-between gap-5">
      ...
      <div className="bg-footer-bg text-gray-300">
        ...
        <div className="bg-black/20 border-t border-white/10">
          <div className="max-w-page mx-auto px-4 py-4 flex flex-col sm:flex-row items-center justify-between gap-3">
