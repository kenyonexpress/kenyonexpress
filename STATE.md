...
‏`/category` עומד על **24.07%** ו-`/products` על **34.87%** מול האתר החי,
לעומת 8.07 ו-10.71 שרשומים. שתיהן קדמו לסבב הזה ולא נבדקו כאן.
‏`CategoryProductCard` מגיש `<img>` גולמי, כלומר **עוקף את האופטימייזר
לחלוטין** בשלושת הדפים האלה. זו הבדיקה הבאה המתבקשת.
