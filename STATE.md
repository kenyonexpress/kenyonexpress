...
המסכים). ‏**ה-goal הפעיל: [55] Invoices — שלב המדידה נעשה, ראה את הסעיף שלו
תחת `## Next Task`. ההמשך הוא המיגרציה ושכבת המסמך.**
...
- [ ] **[55] Invoices.** ‏**בעיצומו. שלוש מדידות שנעשו מול הפרודקשן ומול
