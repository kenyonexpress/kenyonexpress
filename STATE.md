...
### מה נדרש כדי לרדת מתחת ל-11%

הכרעה שלך על שלוש שאלות: (א) מה מזין את שתי שורות המחיר הנוספות בכרטיס, או
לוותר עליהן ולקבל את פער הגובה; (ב) sidebar או התכנסות לחי; (ג) container
1320px מול 1170px שנמדדו בחי.

**סתירה נוספת שלא הכרעתי**: ההנחיה דורשת container 1320px, בעוד המדידה מהחי
נותנת 1200px עם תוכן 1170px. השארתי 1320 לפי ההנחיה. בגלל זה גם החזרתי את
הלוגו ל-40px אחרי שניסיתי את 71px שנמדדו בחי: בקונטיינר 1320 הלוגו נוחת על
פיקסלים אחרים והציון הורע.
