...
**סדר עבודה מוצע להמשך:** להתחיל מהבאנד ‏y600-700 (‏46%) — אזור הקנייה. שם
יושבים "הוסף לסל" הצהוב ו-"קנה עכשיו" הכתום, וכפתור שני שאין לו מקבילה בתבנית
החיה הוא הסבר סביר לפער מרוכז. למדוד את גובה אזור הקנייה מול
‏`refs/live-product.png` לפני שנוגעים ב-CSS.
