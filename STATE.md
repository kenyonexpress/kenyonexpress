...
שני האחרונים נכפים ב-DB לסכום 100 כדי שלא יוכלו לסתור. הנימוק המלא
...
**‏2. אין ולו מוצר אחד בפרודקשן שאפשר לתמחר תחת המודל החדש.**
נשאל ה-DB החי: **`platform_percent` הוא NULL בכל 16 המוצרים הפעילים.**
תחת המודל החדש האחוז חובה, אז כל המוצרים בפרודקשן לא-תמחיריים ולא-זמינים.
זה לא באג בקוד אלא **פער דאטה**: המודל חדש והאחוזים מעולם לא הוזנו.
נדרש להזין אחוז פר-מוצר באדמין (או עדכון גורף) לפני שהחנות מוכרת.
