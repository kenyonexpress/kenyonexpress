...
**סדר עבודה מוצע:** קודם (2), כי התנגשות פריסה מזיזה את כל מה שמתחתיה ויכולה
להסביר חלק מ-(1) ומ-(3); רק אחר כך למדוד שוב, ורק אז לגעת בגיאומטריה של
עמודת הסיכום מול התבנית החיה.
