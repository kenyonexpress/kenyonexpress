...
⚠️ **‏081, ‏082 ו-083 הוחלו על המסד המקומי בלבד. אף אחת לא הוחלה על
הפרודקשן.** ‏081 החליפה מקומית את 079 (גרסת ה-escrow) שהייתה מותקנת שם.

### מה נשאר פתוח מהתור
- ‏`fn_post_journal` עדיין לא מחווט למסלול הקופון.
- החלת המיגרציות התלויות על המרוחק (‏050, 051, 070, 081, 082, 083) — דורש
  מעבר על הקטלוג באדמין קודם, ו-082/083 הן כעת **תנאי מקדים להשקה**: בלי
  ‏082 אי אפשר להירשם, בלי 083 אי אפשר לשלם לספק.
