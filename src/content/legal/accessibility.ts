...
export const accessibilityStatement: LegalDocument = {
  ...
  blocks: [
    ...
    {
      type: 'paragraph',
      text: 'אם נתקלתם בעמוד, בפעולה או בתוכן שאינם נגישים, נשמח לדעת ולתקן. אפשר לפנות דרך עמוד "צור קשר" באתר, בדואר אלקטרוני support@kenyonexpress.co.il או בוואטסאפ 052-463-5550. בפנייה כדאי לציין את כתובת העמוד, את הפעולה שניסיתם לבצע ואת סוג הטכנולוגיה המסייעת שבה אתם משתמשים, כדי שנוכל לשחזר את התקלה.',
    },
    {
      type: 'paragraph',
