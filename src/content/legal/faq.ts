...
export const faqEntries: readonly FaqEntry[] = [
  ...
  },
  {
    ...
    answer:
      'כן. על כל תשלום מונפקת חשבונית מס / קבלה, והיא זמינה להורדה בעמוד אישור ההזמנה ובעמוד ההזמנה באזור האישי. קובץ החשבונית עצמו לא נשלח אליכם במייל, ההורדה היא בלחיצה שלכם.',
  },
  {
