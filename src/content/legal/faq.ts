...
export const faqEntries: readonly FaqEntry[] = [
  ...
  },
  {
    ...
    answer:
      'כן. על כל תשלום מונפקת חשבונית מס / קבלה, והיא זמינה להורדה בעמוד אישור ההזמנה ובעמוד ההזמנה באזור האישי. אנחנו לא שולחים אותה אוטומטית, ההורדה היא בלחיצה שלכם.',
  },
  {
