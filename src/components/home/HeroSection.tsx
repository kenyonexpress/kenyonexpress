...
import { HERO_SINGLEFILE_SLIDES, HERO_SLIDER_HEIGHT_CLASS } from '@/lib/hero-singlefile-data'
...
export default function HeroSection({
  ...
  return (
    <section
      ...
      dir="rtl"
      className={`mx-auto flex w-full max-w-hero-row flex-col border-b border-gray-200 font-sans lg:flex-row lg:items-stretch ${HERO_SLIDER_HEIGHT_CLASS}`}
    >
      <HeroCategorySidebar />
