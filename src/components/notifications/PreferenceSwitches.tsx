  ...
  return (
    <div>
      <p className="text-sm text-muted">
        ...
        נשלחות תמיד, כי הן חלק ממה שקניתם. במייל נשלחים רק אישור הרכישה, תזכורת לפני תפוגת קופון,
        קופון מתנה למקבל, איפוס סיסמה והתראת אבטחה. כל השאר מגיע כהתראה בדפדפן עם קישור לדף ההזמנה.
      </p>
