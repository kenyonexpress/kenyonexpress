      ...
      <header dir="rtl" className="sticky top-0 z-40 w-full border-b border-border bg-white">
        ...
        */}
        ...
        {/*
          ...
          live's 50 and 110 less their 1px border. The handheld number was 83
          until 2026-09-18; see the border-row measurement in tokens.css for
          what it was and what the 34px cost. `xl` and not `lg` because
