  ...
  return (
    ...
    >
      ...
      <div className="min-w-0 flex-1">
        <p className="font-bold text-heading text-sm">רוצים לדעת כשההזמנה יוצאת לדרך?</p>
        <p className="mt-1 text-gray-500 text-xs leading-relaxed">
          התראה בדפדפן כשהקופון מוכן, כשהמשלוח יוצא וכשנכנס קאשבק לארנק. בלי פרסומות, ואפשר לכבות
          בכל רגע.
        </p>
      </div>
      <Link
