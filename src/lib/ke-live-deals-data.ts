/**
 * THE DEAL IMAGES ARE `.webp` HERE AND `.avif` ON DISK BESIDE THEM, AND THAT IS
 * A DELIBERATE DEVIATION FROM THE VERBATIM RECORD.
 *
 * Next 16 lists AVIF in `BYPASS_TYPES` (node_modules/next/dist/server/
 * image-optimizer.js:165, beside SVG, ICO, ICNS, BMP, JXL and HEIC). An AVIF
 * source is returned to the browser UNCHANGED at every requested width - not a
 * sharp failure and not a misconfiguration, it is what that list means.
 *
 * Measured 2026-09-10 against the production build: `ke-live-deal-0.avif`
 * answered 20215 bytes at w=256, w=384 and w=640 alike, byte-identical to the
 * file on disk, with a 200 and `content-type: image/avif`. Thirty-two of these
 * paint at 157px on a 412px phone. The same image re-encoded from WebP is 6214
 * bytes at w=256.
 *
 * So the sources are WebP now and the optimizer can do its job. The `.avif`
 * files are left in place rather than deleted: they are the original capture,
...
export const KE_LIVE_DEALS: Product[] = [
  {
    ...
    kenyon_price: 949,
    full_price: 1500,
    images: ['/images/products/ke-live-deal-0.webp'],
    stock_quantity: 1,
  ...
  },
  {
    ...
    kenyon_price: 20,
    full_price: 50,
    images: ['/images/products/ke-live-deal-1.webp'],
    stock_quantity: 1,
  ...
  },
  {
    ...
    kenyon_price: 3900,
    full_price: 5600,
    images: ['/images/products/ke-live-deal-2.webp'],
    stock_quantity: 1,
  ...
  },
  {
    ...
    kenyon_price: 250,
    full_price: 500,
    images: ['/images/products/ke-live-deal-3.webp'],
    stock_quantity: 1,
    category: { name_he: 'יופי בריאות וטיפוח', slug: 'beauty-health' },
  },
  {
    ...
    kenyon_price: 9,
    full_price: null,
    images: ['/images/products/ke-live-deal-4.webp'],
    stock_quantity: 1,
    category: { name_he: 'יופי בריאות וטיפוח', slug: 'beauty-health' },
  },
  {
    ...
    kenyon_price: 99,
    full_price: 195,
    images: ['/images/products/ke-live-deal-5.webp'],
    stock_quantity: 1,
  ...
  },
  {
    ...
    kenyon_price: 9,
    full_price: null,
    images: ['/images/products/ke-live-deal-7.webp'],
    stock_quantity: 1,
  ...
  },
  {
    ...
    kenyon_price: 160,
    full_price: null,
    images: ['/images/products/ke-live-deal-8.webp'],
    stock_quantity: 1,
  ...
  },
  {
    ...
    kenyon_price: 900,
    full_price: null,
    images: ['/images/products/ke-live-deal-9.webp'],
    stock_quantity: 1,
    category: { name_he: 'צימרים מלונות ונופש', slug: 'vacation' },
  },
  {
    ...
    kenyon_price: 9,
    full_price: null,
    images: ['/images/products/ke-live-deal-10.webp'],
    stock_quantity: 1,
    category: { name_he: 'יופי בריאות וטיפוח', slug: 'beauty-health' },
  },
  {
    ...
    kenyon_price: 9,
    full_price: null,
    images: ['/images/products/ke-live-deal-11.webp'],
    stock_quantity: 1,
    category: { name_he: 'יופי בריאות וטיפוח', slug: 'beauty-health' },
  },
  {
    ...
    kenyon_price: 99,
    full_price: 150,
    images: ['/images/products/ke-live-deal-12.webp'],
    stock_quantity: 1,
    category: { name_he: 'יופי בריאות וטיפוח', slug: 'beauty-health' },
  },
  {
    ...
    kenyon_price: 20,
    full_price: null,
    images: ['/images/products/ke-live-deal-13.webp'],
    stock_quantity: 1,
    category: { name_he: 'יופי בריאות וטיפוח', slug: 'beauty-health' },
  },
  {
    ...
    kenyon_price: 9,
    full_price: null,
    images: ['/images/products/ke-live-deal-14.webp'],
    stock_quantity: 1,
    category: { name_he: 'יופי בריאות וטיפוח', slug: 'beauty-health' },
  },
  {
    ...
    kenyon_price: 699,
    full_price: 899,
    images: ['/images/products/ke-live-deal-15.webp'],
    stock_quantity: 1,
    category: { name_he: 'צימרים מלונות ונופש', slug: 'vacation' },
  },
  {
    ...
    kenyon_price: 99,
    full_price: 149,
    images: ['/images/products/ke-live-deal-16.webp'],
    stock_quantity: 1,
    category: { name_he: 'יופי בריאות וטיפוח', slug: 'beauty-health' },
  },
  {
    ...
    kenyon_price: 249,
    full_price: null,
    images: ['/images/products/ke-live-deal-17.webp'],
    stock_quantity: 1,
    category: { name_he: 'יופי בריאות וטיפוח', slug: 'beauty-health' },
  },
  {
    ...
    kenyon_price: 1,
    full_price: 400,
    images: ['/images/products/ke-live-deal-18.webp'],
    stock_quantity: 1,
    category: { name_he: 'מסעדות ובתי קפה', slug: 'restaurants-cafes' },
  },
  {
  ...
  },
  {
    ...
    kenyon_price: 999,
    full_price: 1600,
    images: ['/images/products/ke-live-deal-20.webp'],
    stock_quantity: 1,
    category: { name_he: 'בעלי מקצוע', slug: 'professionals' },
  },
  {
    ...
    kenyon_price: 2000,
    full_price: null,
    images: ['/images/products/ke-live-deal-21.webp'],
    stock_quantity: 1,
    category: { name_he: 'צימרים מלונות ונופש', slug: 'vacation' },
  },
  {
    ...
    kenyon_price: 800,
    full_price: 1000,
    images: ['/images/products/ke-live-deal-22.webp'],
    stock_quantity: 1,
    category: { name_he: 'צימרים מלונות ונופש', slug: 'vacation' },
  },
  {
    ...
    kenyon_price: 150,
    full_price: 200,
    images: ['/images/products/ke-live-deal-23.webp'],
    stock_quantity: 1,
    category: { name_he: 'תינוקות וילדים', slug: 'baby-kids' },
  },
  {
    ...
    kenyon_price: 180,
    full_price: 199,
    images: ['/images/products/ke-live-deal-24.webp'],
    stock_quantity: 1,
    category: { name_he: 'מסעדות ובתי קפה', slug: 'restaurants-cafes' },
  },
  {
    ...
    kenyon_price: 99,
    full_price: null,
    images: ['/images/products/ke-live-deal-25.webp'],
    stock_quantity: 1,
    category: { name_he: 'מסעדות ובתי קפה', slug: 'restaurants-cafes' },
  },
  {
    ...
    kenyon_price: 480,
    full_price: null,
    images: ['/images/products/ke-live-deal-26.webp'],
    stock_quantity: 1,
    category: { name_he: 'כללי', slug: 'general' },
  },
  {
    ...
    kenyon_price: 800,
    full_price: 1000,
    images: ['/images/products/ke-live-deal-27.webp'],
    stock_quantity: 1,
  ...
  },
  {
    ...
    kenyon_price: 1800,
    full_price: 2100,
    images: ['/images/products/ke-live-deal-28.webp'],
    stock_quantity: 1,
    category: { name_he: 'טלפונים מחשבים ואביזרים', slug: 'phones-computers' },
  },
  {
    ...
    kenyon_price: 300,
    full_price: 350,
    images: ['/images/products/ke-live-deal-29.webp'],
    stock_quantity: 1,
    category: { name_he: 'כללי', slug: 'general' },
  },
  {
    ...
    kenyon_price: 600,
    full_price: 675,
    images: ['/images/products/ke-live-deal-30.webp'],
    stock_quantity: 1,
    category: { name_he: 'כללי', slug: 'general' },
  },
  {
    ...
    kenyon_price: 90,
    full_price: 110,
    images: ['/images/products/ke-live-deal-31.webp'],
    stock_quantity: 1,
    category: { name_he: 'כללי', slug: 'general' },
  },
]
