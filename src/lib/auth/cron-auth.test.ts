...
describe('scheduled routes authenticate', () => {
  ...
  it('names every route it found, so a new one is a visible diff', () => {
    ...
    expect(cronRouteFiles()).toEqual([
      ...
      'src/app/api/cron/deals-autopilot/route.ts',
      ...
      'src/app/api/cron/price-schedule/route.ts',
      'src/app/api/cron/price-snapshot/route.ts',
      'src/app/api/cron/reap-carts/route.ts',
      'src/app/api/cron/reconcile/route.ts',
      'src/app/api/cron/retention/route.ts',
      'src/app/api/cron/settlement-reconcile/route.ts',
