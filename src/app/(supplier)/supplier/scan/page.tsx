...
/**
 * Lives under /supplier/scan; /scan is a permanent redirect here (next.config).
 * Until the 2026-09-21 go-live dry run this path was a redirect TO /scan while
 * next.config redirected /scan back here, and the scanner was a redirect loop
 * that showed suppliers a blank page: measured with a real supplier session,
 * /scan -> 308 -> /supplier/scan -> /scan. The screen itself lived at /scan,
 * where the camera permission policy did not name it.
 */
