...
/**
 * The canonical returns document, at the URL the site actually links to.
 *
 ...
 * rendering `src/content/legal`; and `/legal/returns`, unlinked and noindexed,
 ...
 * `/legal/returns` permanently redirects to this path. That is the promotion the
...
export const metadata: Metadata = {
  ...
  alternates: alternatesFor('/refund_returns'),
}

export default function Page() {
  return (
    <LegalArticle doc={doc}>
      <LegalContactBlock intro="לביטול הזמנה, לבירור על החזר או להסלמה של פנייה שלא נענתה, אנחנו זמינים בערוצים הבאים:" />
    </LegalArticle>
  )
}
