...
/**
 * The canonical terms document, at the URL the site actually links to.
 *
 ...
 * rendering `src/content/legal`; and `/legal/terms`, unlinked and noindexed,
 ...
 * `/legal/terms` permanently redirects to this path. That is the promotion the
